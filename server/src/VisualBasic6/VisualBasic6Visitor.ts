...
import { ModuleReferenceGUIDContext } from './VisualBasic6Parser';
...
export interface VisualBasic6Visitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by `VisualBasic6Parser.moduleReferenceGUID`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitModuleReferenceGUID?: (ctx: ModuleReferenceGUIDContext) => Result;
